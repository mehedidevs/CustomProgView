package com.mehedi.customprogreesbar.roundcornerprogressbar
...
import com.mehedi.customprogreesbar.R
import com.mehedi.customprogreesbar.roundcornerprogressbar.common.AnimatedRoundCornerProgressBar
...
open class TextRoundCornerProgressBar : AnimatedRoundCornerProgressBar,
    ...
    private fun drawTextProgressMargin() {
        ...
        params.setMargins(textProgressMargin, 0, textProgressMargin, -7)
...
//        }
    ...
    private fun convertLinearLayoutToDrawable(
        linearLayout: LinearLayout,
    ): BitmapDrawable {
        // Measure and layout the LinearLayout
        ...
        val layout_height =
            if (linearLayout.measuredHeight >= 100) 100 else linearLayout.measuredWidth

        // Create a Bitmap with the measured dimensions of the LinearLayout
        ...
        // Create a Canvas and draw the LinearLayout onto the Bitmap
        val canvas = Canvas(bitmap)
        linearLayout.draw(canvas)

        // Create a BitmapShader with the Bitmap and set it to the Paint
        val paint = Paint().apply {
            shader = BitmapShader(bitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP)
            isAntiAlias = true
        }

        // Create a rounded rectangle using the BitmapShader
